...
<!--        <el-button @click="updatePic" style="float: right; margin-top: 20px; margin-right: 10px">上传</el-button>-->
        <van-nav-bar title="选择图片-语种" right-text="识别" left-arrow @click-left="toHome"  @click-right="updatePic" />
...
<script>
    import {Upload_lan} from "../api/index";
    ...
    export default {
        ...
        methods: {
            ...
            updatePic() {
                ...
                param.append('filetype', this.type)
                for (let i = 0; i < length; i++) {
                ...
                Upload_lan(param).then((response) => {
