...
<!--        <el-button @click="updatePic" style="float: right; margin-top: 20px; margin-right: 10px">上传</el-button>-->
        <van-nav-bar title="选择图片-车牌" right-text="识别" left-arrow @click-left="toHome"  @click-right="updatePic" />
...
<script>
    import {Upload_carcard} from "../api/index";
    ...
    export default {
        ...
        methods: {
            ...
            updatePic() {
                ...
                Upload_carcard(param).then((response) => {
